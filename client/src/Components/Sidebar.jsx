...
import assets from "../assets/chat-app-assets/chat-app-assets/assets.js"
      ...
      <div className='pb-5'>
          <div className='flex justify-between items-center'>
            ...
            <div className="relative py-2 group">
                ...
                bg-[#282142] border-gray-600 text-gray-100 hidden group-hover:block'>
           ...
           {filteredUsers.map((user,index)=>(
            <div onClick={()=>{setSelectedUser(user);setUnseenMessages(prev=>
             ...
             key={index} className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser?._id===user._id? 'bg-[#282142]/50': ''}`}>
              ...
              {unseenMessages[user._id] >0 && <p className='absolute top-4 right-4 txt-xs h-5 w-5 
